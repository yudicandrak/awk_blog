	...
	$(function(){
		$.post("cont_slide", function(data) {
			...
			for (var k in obj){
				...
				$("#detailpost"+k).html(obj[k]['fullname']+" - "+formatDate2(new Date(obj[k]['post_date'])));
			...
			<div class="col-md-9 col-sm-9 col-xs12">
				...
				<div class="row">
					<div class="btn-toolbar">
						<div id="body_page" class="btn-group"></div>
					</div>
				</div>
			</div>
			<!-- end home page-->
			<!-- taxonomi dashboard !-->
			<div class="col-md-3 col-sm-3 col-xs-12" style="top:20px">
				<div class="x_title">
		...
		$.ajax({
			...
			success : function(data) {
				...
				for (var k in obj){
					...
					ul.innerHTML = "<img onclick='window.location.replace(\"view_post?eid_post="+obj[k]['id_post']+"\")' src='{{ base_url }}asset/image_post/"+obj[k]['media']+"' class='avatar img_hover' alt='"+obj[k]['post_title']+"' style='height:150px; width:150px; margin-right:10px'>"+
									"<div class='message_date'>"+
										"<a onclick='alert(\"coming soon\")' class='img_hover'>"+obj[k]['fullname']+"</a>"+
										"<br>"+
				...
				for(i = 1; i<=obj[0]['count_post']; i++){
					var button = document.createElement('button');
					if(i == page){
						button.setAttribute("class", "btn btn-info active");
					}else{
						button.setAttribute("class", "btn btn-info");
					}
					button.setAttribute("onclick", "get_post("+i+")");
					button.innerHTML = i;
					document.getElementById('body_page').appendChild(button);
				}
						...
						div.innerHTML =	"<div class='x_content'>"+
											"<ul class='list-unstyled' style='padding:-100px'>"+
												"<li>"+
													"<a>"+
														"<span class='image'>"+
															"<img class='img-circle' src='"+obj.isi[k]['foto']+"' alt='img' style='width:35px'/> &nbsp"+
														"</span>"+
														"<span>"+
															"<span style='font-weight: bold;'>"+obj.isi[k]['fullname']+"</span> &nbsp"+
